                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="4"><input type="text" placeholder="-" v-model="route.nodes_sequence_i" :disabled="route.type==3"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="4"><input type="text" placeholder="-" v-model="route.nodes_sequence_r" :disabled="route.type==3"></td>
